...
def chat():
    ...
    Body JSON:
    {
        ...
        "max_new_tokens": 2048,       // opsional, default 2048
...
def chat_rag():
    ...
    try:
        ...
        return jsonify({
            ...
            "thought_process": result.get("thought_process", result["analisis"]),
            "jawaban": result["jawaban"],
            "completion": result.get("completion", result["jawaban"]),
